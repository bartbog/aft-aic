...
Literals and update actions are related by natural mappings \litof and \actof, where $\litof(\add a)= a, \litof(\remove a) = \lnot a, \actof(a) = \add a$ and $\actof(\lnot a) = \remove a$.  These mappings naturally extend to sets of literals/action sets. 
...
\todo{define the ``shifting property''?}
