...
\end{proposition}
\begin{proof}
 It is easy to verify that \Op also satisfies inertia and completeness.
 For consistency, observe that the syntactic restrictions on AICs guarantee that the set $\{\head(r)\mid r\in \aics \land \UU(\db)\models\body(r)\}$ is always consistent. 
