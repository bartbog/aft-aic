...
% Formally, our operator should sati
% 
...
\bart{Say something about this? That this is due to the fact that there are rules producing +a as well as rules producing -a}
\begin{definition}
