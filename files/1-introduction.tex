...
In this work, we begin by defining a new class of semantics for AICs that avoids these problems: \emph{grounded repairs}.
Grounded repairs are natural counterparts to existing semantics in various non-monotonic reasoning domains, and we discuss how they to other semantics for AICs.
