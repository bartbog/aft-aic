...
In this work\footnote{A previous version of this text has been published as \cite{}. This work extends the previous with proofs of all results, extra examples and an in-depth comparison with logic programming. \luis{if we like the ``publication history'' we can kill this footnote}}, we transfer existing work from the field of non-monotonic reasoning to AICs.
