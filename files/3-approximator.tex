...
not hold. Consider for instance the following set $\aics$ of AICs
 ...
 However, also $a \mapsto \ltrue, b\mapsto \ltrue, c\mapsto \lfalse$ is a well-founded repair, obtained by first applying the second rule and then the first one.
...
From the following existing result, we easily find how justified repairs and the AFT-well-founded repair relate. 
...
\begin{corollary}
 The AFT-well-founded repair (and hence also the Kripke-Kleene repair) approximates all justified repairs. 
\end{corollary}
