...
not hold. Consider for instance the following set $\aics$ of AICs
 ...
 However, $a \mapsto \ltrue, b\mapsto \ltrue, c\mapsto \lfalse$ is also well-founded repair, obtained by applying first the second rule and then the first one.
...
\begin{proposition}[Lemma 19 of \cite{iclp/Cruz-Filipe16}]
