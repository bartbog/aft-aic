...
A lattice is \emph{distributive} if $\land$ and $\lor$ distribute over each other, a bounded lattice
is \emph{complemented} if every element $x\in L$ has a complement: an element $\lnot x \in L$
