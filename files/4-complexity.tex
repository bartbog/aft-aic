...
All complexity results are in terms of the size of $\eta$ and $\atoms$.
...
\begin{proposition}
  The task of verifying if a proposed repair is a stable repair $\fulldb$ is NP-complete.
\end{proposition}
\longpaper{\begin{proof}
  ...
  This operator preserves stable semantics \bart{Why? It does not preserve the operator.}, and therefore allows us to compute stable models of simple logic programs by first translating them (in linear time) to sets of AICs.
