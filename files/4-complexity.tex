...
\luis{I'm a bit uncertain about the notation here, so I'm using $T_P$ as a placeholder for something with the right font.}
...
\luis{I need to think a bit about this, but it seems to me that we can actually invert this transformation.  That would then give \emph{upper} bounds for these semantics.}
