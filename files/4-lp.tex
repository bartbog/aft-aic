...
\luis{I tried to write this in a way that the question ``is there a precise correspondence between semantics using their translation?'' is not the obvious one, but I'm not sure we shouldn't discuss it. I need to look at this more carefully.}
