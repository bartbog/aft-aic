...
Since the well-founded model of a logic program is the least precise partial stable model, and similar for AICs, we immediately find the following corollary. 
...
\begin{proof}[Proof of Theorem \ref{thm:partialstable-LP}]
 ...
 Now, the result easily follows from the facts that if $\PP$ is simple, then
