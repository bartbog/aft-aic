...
It is striking that many intuitions about what ``good'' repairs are, such as the principle of minimality of change, are similar to intuitions that surfaced in various domains of non-monotonic reasoning. %, such as logic programming and default logic . 
